...
const TESN_PROJECTS: Preset[] = [
    {
        name: "TESN - Containment Breach", bpm: 145, tracks: ([
            ...
            { ...deepClone(INITIAL_TRACKS[2]), type: 'reson', loadedInstrumentPresetName: 'TESN - Rebar Hit', params: TESN_INSTRUMENTS.find(p=>p.name==='TESN - Rebar Hit')!.params, patternLength: 7, patterns: [createPatternFromSequence([null,0.8,null,null,0.8,null,null], 'C4')], fxSends: { drive: 0.3, sidechain: 0, reverb: 0.2, delay: 0.3 }, volume: 0.3 },
    ...
    },
    {
        name: "TESN - Red Alert", bpm: 138, tracks: ([
            ...
            { ...deepClone(INITIAL_TRACKS[1]), type: 'artifice', loadedInstrumentPresetName: 'TESN - Noise Clap', params: TESN_INSTRUMENTS.find(p=>p.name==='TESN - Noise Clap')!.params, patterns: [createPatternFromSequence([null,null,null,null,1,null,null,null,null,null,null,null,1,null,null,null], 'C4')], fxSends: { drive: 0.1, reverb: 0.3, delay: 0.1, sidechain: 0 }},
...
const MAINFRAME_PULSE_PROJECTS: Preset[] = [
    {
        name: "MP - System Corridor", bpm: 138, tracks: [
            ...
            { ...deepClone(INITIAL_TRACKS[3]), type: 'arcane', loadedInstrumentPresetName: 'DHT - Warehouse Stab', params: TECHNO_PRESET_LIBRARY.arcane.find(p=>p.name==='DHT - Warehouse Stab')!.params, patternLength: 32, patterns: [createPatternFromSequence(Array(32).fill(null).map((_,i)=>[7, 15, 23].includes(i) ? 0.8 : null), 'A#3')], fxSends: { delay: 0.7, reverb: 0.5, drive: 0, sidechain: 0.3 }},
            { ...deepClone(INITIAL_TRACKS[4]), type: 'hat', loadedInstrumentPresetName: 'DHT - Rusted Hat', params: TECHNO_PRESET_LIBRARY.hat.find(p=>p.name==='DHT - Rusted Hat')!.params, patterns: [createPatternFromSequence(Array(16).fill(null).map((_,i)=>i % 2 === 0 ? 0.6 : null), 'C5')], fxSends: { delay: 0.5, reverb: 0.1, drive: 0, sidechain: 0 }, volume: 0.3 },
    ...
    },
    {
        name: "MP - Logic Gate", bpm: 140, tracks: [
            ...
            { ...deepClone(INITIAL_TRACKS[3]), type: 'artifice', loadedInstrumentPresetName: 'DHT - Gritty Stab', params: TECHNO_PRESET_LIBRARY.artifice.find(p=>p.name==='DHT - Gritty Stab')!.params, patterns: [createPatternFromSequence([null,null,null,null,0.9,null,null,null,null,null,null,null,null,null,0.8,null], 'C4')], fxSends: { delay: 0.6, reverb: 0.3, drive: 0.1, sidechain: 0.2 }},
            { ...deepClone(INITIAL_TRACKS[4]), type: 'hat', loadedInstrumentPresetName: 'DHT - Dark Shaker', params: TECHNO_PRESET_LIBRARY.hat.find(p=>p.name==='DHT - Dark Shaker')!.params, patterns: [createPatternFromSequence(Array(16).fill(null).map((_,i)=>[3,7,11,15].includes(i) ? 0.7 : null), 'D5')], fxSends: { delay: 0.4, reverb: 0.1, drive: 0, sidechain: 0 }, volume: 0.35 },
            ...Array(3).fill(null).map((_,i) => ({ ...deepClone(INITIAL_TRACKS[i+5]), volume: 0 }))
        ],
    ...
    },
    {
    ...
    },
     {
        name: "MP - Null Pointer", bpm: 139, tracks: [
            { ...deepClone(INITIAL_TRACKS[0]), loadedInstrumentPresetName: 'DHT - Industrial Hit', params: TECHNO_PRESET_LIBRARY.kick.find(p=>p.name==='DHT - Distorted Slam')!.params, patterns: [createPatternFromSequence([1,null,0.7,null,1,null,1,null,1,null,0.7,null,1,null,1,null], 'C2')], volume: 0.4 },
            ...
            { ...deepClone(INITIAL_TRACKS[2]), type: 'reson', loadedInstrumentPresetName: 'DHT - Alien Tom', params: TECHNO_PRESET_LIBRARY.reson.find(p=>p.name==='DHT - Alien Tom')!.params, patternLength: 9, patterns: [createPatternFromSequence([null,null,null,0.8,null,null,null,0.8,null], 'C6')], fxSends: { delay: 0.8, reverb: 0.6, drive: 0, sidechain: 0 }, volume: 0.33 },
            { ...deepClone(INITIAL_TRACKS[3]), type: 'ruin', loadedInstrumentPresetName: 'DHT - Industrial Impact', params: TECHNO_PRESET_LIBRARY.ruin.find(p=>p.name==='DHT - Industrial Impact')!.params, patternLength: 13, patterns: [createPatternFromSequence([null,null,0.9,null,null,null,0.9,null,null,0.9,null,null,null], 'A1')], fxSends: { delay: 0.5, reverb: 0.3, drive: 0.2, sidechain: 0.2 }},
            { ...deepClone(INITIAL_TRACKS[4]), type: 'shift', loadedInstrumentPresetName: 'DHT - Scanning Drone', params: TECHNO_PRESET_LIBRARY.shift.find(p=>p.name==='DHT - Scanning Drone')!.params, patterns: [createPatternFromSequence([0.7, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null], 'C2', 0.7, 16)], fxSends: { delay: 0.7, reverb: 0.8, drive: 0, sidechain: 0.6 }, volume: 0.28 },
            ...Array(3).fill(null).map((_,i) => ({ ...deepClone(INITIAL_TRACKS[i+5]), volume: 0 }))
        ],
    ...
    },
    {
    ...
    },
     {
        name: "RR - Tetanus", bpm: 142, tracks: [
            ...
            { ...deepClone(INITIAL_TRACKS[2]), type: 'reson', loadedInstrumentPresetName: 'RR - Impact Wrench', params: RUBBLE_RUST_INSTRUMENTS.find(p=>p.name==='RR - Impact Wrench')!.params, patternLength: 16, patterns: [createPatternFromSequence([null,null,0.8,null,null,null,null,null,null,0.8,null,null,null,null,null,null], 'F#4')], fxSends: { drive: 0.2, reverb: 0.6, delay: 0.7, sidechain: 0 }},
...
const HYPNOTIC_STATE_PROJECTS: Preset[] = [
    ...
    },
    {
        name: "HS - Polyrhythm", bpm: 130, tracks: [
            ...
            { ...deepClone(INITIAL_TRACKS[1]), type: 'reson', loadedInstrumentPresetName: 'HS - Tribe Perc', params: HYPNOTIC_STATE_INSTRUMENTS.find(p=>p.name==='HS - Tribe Perc')!.params, patternLength: 9, patterns: [createPatternFromSequence([null,null,0.8,null,null,0.8,null,null,0.7], 'C5')], fxSends: { delay: 0.7, reverb: 0.5, drive: 0, sidechain: 0 }},
            { ...deepClone(INITIAL_TRACKS[2]), type: 'shift', loadedInstrumentPresetName: 'HS - Filtered Scan', params: HYPNOTIC_STATE_INSTRUMENTS.find(p=>p.name==='HS - Filtered Scan')!.params, patternLength: 11, patterns: [createPatternFromSequence([null,null,null,null,0.9,null,null,null,null,null,null], 'F3')], fxSends: { delay: 0.8, reverb: 0.6, drive: 0, sidechain: 0.2 }},
            ...
            { ...deepClone(INITIAL_TRACKS[4]), type: 'kick', loadedInstrumentPresetName: 'DHT - Tunnel Rumble', params: TECHNO_PRESET_LIBRARY.kick.find(p=>p.name==='DHT - Tunnel Rumble')!.params, patternLength: 32, patterns: [createPatternFromSequence(Array(32).fill(0.7), 'A0')], fxSends: { delay: 0, reverb: 0.9, drive: 0.2, sidechain: 0 }, volume: 0.2 },
            ...Array(3).fill(null).map((_,i) => ({ ...deepClone(INITIAL_TRACKS[i+5]), volume: 0 }))
        ],
    ...
    },
    {
        name: "HS - Ritual", bpm: 128, tracks: [
            ...
            { ...deepClone(INITIAL_TRACKS[3]), type: 'hat', loadedInstrumentPresetName: 'HS - Shifting Hat', params: HYPNOTIC_STATE_INSTRUMENTS.find(p=>p.name==='HS - Shifting Hat')!.params, patterns: [createPatternFromSequence([null,null,0.8,null,null,null,0.8,null,null,null,0.8,null,null,null,0.8,null], 'C5')], fxSends: { delay: 0.7, reverb: 0.6, drive: 0, sidechain: 0.1 }},
    ...
    },
    {
        name: "HS - Afterhours", bpm: 126, tracks: [
            ...
            { ...deepClone(INITIAL_TRACKS[1]), type: 'alloy', loadedInstrumentPresetName: 'HS - Poly Bleep', params: HYPNOTIC_STATE_INSTRUMENTS.find(p=>p.name==='HS - Poly Bleep')!.params, patternLength: 32, patterns: [createPatternFromSequence([null,null,null,0.8,null,null,null,null,null,null,0.7,null,null,null,null,null,null,null,null,null,null,null,null,0.8,null,null,null,null,null,null,0.7,null], 'G5')], fxSends: { delay: 0.9, reverb: 0.8, drive: 0, sidechain: 0 }},
            { ...deepClone(INITIAL_TRACKS[2]), type: 'shift', loadedInstrumentPresetName: 'HS - Filtered Scan', params: HYPNOTIC_STATE_INSTRUMENTS.find(p=>p.name==='HS - Filtered Scan')!.params, patternLength: 64, patterns: [createPatternFromSequence([0.9], 'G3', 0.9, 64)], fxSends: { delay: 0.7, reverb: 0.7, drive: 0, sidechain: 0.6 }, volume: 0.25 },
            { ...deepClone(INITIAL_TRACKS[3]), type: 'artifice', loadedInstrumentPresetName: 'DHT - Noise Hit', params: TECHNO_PRESET_LIBRARY.artifice.find(p=>p.name==='DHT - Noise Hit')!.params, patternLength: 16, patterns: [createPatternFromSequence(Array(16).fill(null).map((_,i)=>i % 4 === 2 ? 0.6 : null), 'C5')], fxSends: { delay: 0.1, reverb: 0.9, drive: 0.1, sidechain: 0 }, volume: 0.28 },
            { ...deepClone(INITIAL_TRACKS[4]), type: 'kick', loadedInstrumentPresetName: 'DHT - Deep Pulse', params: TECHNO_PRESET_LIBRARY.kick.find(p=>p.name==='DHT - Deep Pulse')!.params, patternLength: 64, patterns: [createPatternFromSequence([null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,0.8], 'G0')], fxSends: { delay: 0, reverb: 0.8, drive: 0, sidechain: 0 }, volume: 0.35 },
            ...Array(3).fill(null).map((_,i) => ({ ...deepClone(INITIAL_TRACKS[i+5]), volume: 0 }))
        ],
